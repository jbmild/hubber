...
from funciones.wtoparser import get_normativa, parse_normativa
from funciones.mongo_functions import connectMongoDB, insertar_lista
...
params_4 = "&Language=SPANISH&HSClassificationList=%22(1905*)%22&SearchPage=FE_S_S001&languageUIChanged=true#"
...
if cantidad > 0:
    ...
    for normativa in normativas:
        ...
        normativaParseada = parse_normativa(tabla, language, tipoDoc)
        listaNormativas.append(normativaParseada)
    
    cliente = connectMongoDB()
    insertar_lista(listaNormativas, cliente, "chatbot", "barrerasAlfajores")
    cliente.close()
