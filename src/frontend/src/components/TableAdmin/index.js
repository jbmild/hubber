    ...
    >
      ...
      >
              ...
              :              
                ...
                {data.map((row) => (
                  <TableRow key={row._id} hover onClick={() => handleRowClick(row)}>
                    ...
                    {!isSmallScreen && (
                      <>
                        <TableCell>{row.normativaOrigen}</TableCell>
        ...
        <TablePagination
          ...
          sx={{ flexShrink: 0 }}
        />    
        <DialogDetallesAdmin data={selectedRow} openModal={openModal} handleCloseModal={handleCloseModal} normativas={normativas} setNormativas={setNormativas}/>    
      </Paper>
    </Box>
  );
};
