...
async function getDataFromMongoDB() {
  ...
  try {
    ...
    const database = client.db('pruebaFede'); // Asumiendo que este es el nombre de tu base de datos
    const collection = database.collection('paises_normativas'); //nombre de la coleccion de la base de datos
